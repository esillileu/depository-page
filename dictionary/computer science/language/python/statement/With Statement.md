...
---
# With Statement
> [[Python|파이썬]]에서 [[Block|블록]]을 [[Context Manager|컨텍스트 매니저]]의 [[Context|컨텍스트]]안에서 실행하는 [[Statement|문]]
...
+ [[dictionary/computer science/language/language theory/sementics/Scope|스코프]]를 생성하지 않음 
